...
@PostMapping("/AceptarCita/{idCita}")
    public ResponseEntity<?>Aceptar(@PathVariable("idCita") Long idCita, Principal principal){
       return ResponseEntity.ok(CS.ValidarDisponibilidadYAceptar(idCita, principal.getName()));
    }
}
